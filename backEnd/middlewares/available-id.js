const isAvailableId = (req, res, next) => {
    ...
    // [défini le type de caractères acceptées, ici: carcère de 0 à 9 et de a à f]
    // {défini la quantité de caractères à évaluer selon les crières données}
